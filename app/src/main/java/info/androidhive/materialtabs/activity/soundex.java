...
/**
 * Created by HalFM-1 on 11/12/2015.
 */

import android.util.Log;

/**
 * Created by HalFM-1 on 10/16/2015.
 */
public class soundex{ /* Implements the mapping
   ...
   */
    ...
    //Log.e(soundex.soundex(names[i]) + ' ' + names[i],"soundexs");
